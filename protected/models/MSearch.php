...
class MSearch extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('Grant, Consortia, Task, ProjectTitle, SubAwards, LastName, FirstName, StartDate, EndDate, Publication, DataSet', 'length', 'max'=>255),
			array('InstitutionID, Type', 'length', 'max'=>200),
			...
			array('id, Grant, Consortia, Task, ProjectTitle, SubAwards, LastName, FirstName, StartDate, EndDate, Keyword, Publication, InstitutionID, State, DataSet, Award, Type, Theme1, PersonID, Theme2, Theme3, Theme4, Theme5', 'safe', 'on'=>'search'),
		);
	}
