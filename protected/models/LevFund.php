...
/**
 * This is the model class for table "LevFund".
 *
 * The followings are the available columns in table 'LevFund':
 * @property integer $id
 ...
 */
class LevFund extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LevFund the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('projectTitle', 'length', 'max'=>100),
			array('startDate, endDate, objective, how', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, fundSource, institutionID, amount, projectTitle, startDate, endDate, objective, how, project', 'safe', 'on'=>'search'),
		);
	}
