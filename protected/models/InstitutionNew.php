 ...
 */
class InstitutionNew extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return InstitutionNew the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('personID, projectID', 'length', 'max'=>20),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('InstitutionAbrev, Field3, AmountPerInstitution, ID, InstitutionID, Institution, State, Type, FundRec, personID, projectID', 'safe', 'on'=>'search'),
		);
	}
