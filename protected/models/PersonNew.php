 ...
 * @property Projectnew[] $projectnews
 */
class PersonNew extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return PersonNew the static model class
     */
    ...
    public function rules() {
        ...
        return array(
            ...
            array('intstituionAbbr, institutionID, Institution, firstName, lastName, Role, eMailAddress, secondaryRole, email, degreePursuing, ThesisResearchTopic, Department, Supervisor, CompletionsQuarter, SummerInternship', 'length', 'max' => 255),
    ...
    public function relations() {
        ...
        return array(
            'projectnews' => array(self::MANY_MANY, 'Project', 'project_person(person_id, project_id)'),
        );
    }
